  ...
  return (
    <div className="wrap">
      ...
      <section className="step">
        ...
        <Scorecard />
        <p className="foot">
          <b>「未測定」と出ている欄がある。</b>陰性対照(ラベルを入れ替えた学習)と
          頭部の比較(published と同じ全結合型)は、作業機を他の計算と共有していて
          まだ回し切れていない。<b>測っていないものを 0.000 と書かない</b>ためにこう出している。
          途中経過だけ書いておくと、全結合型は 4 epoch で検証 AUC 0.9659 に達し、
          いま出荷している CAM 型の 22 epoch 後(0.9649)をすでに上回っている ——
          <b>視線が厳密になることの代償は、少なくとも収束の速さにはある。</b>
          <br />
          未学習の同じモデル(学習を一度もしていない)の試験 AUC は 0.4677 で、
          初期値を 5 通り振ると 0.3512〜0.7245 に散る。
          <b>乱数だけで AUC 0.72 が出る</b>ので、陰性対照の合否を「0.5 に近いか」で
          決めることはできない。この基準線は測ってある。
        </p>
      </section>
