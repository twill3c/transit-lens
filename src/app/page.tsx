    ...
    <div className="wrap">
      ...
      <section className="step">
        ...
        <p className="foot">
          ...
          <br />
          <b>published の 0.988 との差 0.020 は、その 6 割が計算予算の差だった。</b>
          フィルタ幅を published と同じ 1.0 に戻し 40 epoch まで回すと、
          試験 AUC は <b>0.9796</b>(再現率は 0.821 → 0.897)まで上がる ——
          これは<b>測る前に「0.975 を超えるが 0.988 には届かない」と書いてから</b>測った。
          残る 0.008 は、参照実装の 25,000 step(約 128 epoch 相当)との差と、
          恒星単位分割の割引で説明のつく範囲にある。
          <b>実装の誤りを疑う根拠は出なかった。</b>
          <b>この広いモデルは出荷していない。</b>頭部の比較は同条件で測り直したが
          (幅 1.0 では CAM 型が 0.9796 対 0.9682 で<b>逆に優位</b>だった —— 全結合型は
          990 万パラメータを 12,516 件で学習するので epoch 17 から過学習する)、
          陰性対照は同条件で回し切れなかった。
          ここに出ている数は<b>すべて、いま動いているモデルで測ったもの</b>である。
          良い方の数字を、別条件で測った対照と並べて出すことはしない。
        </p>
      </section>
